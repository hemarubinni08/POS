...
<head>
    ...
    <title>Retail POS | Edit Brand</title>
...
<body>
    ...
    <header class="top-navbar">
        <a href="${pageContext.request.contextPath}/brand/list" class="btn-back">
    ...
    <main class="main-content">
        <div class="form-card">
            <div class="mb-4">
                <h2 style="font-weight: 800; color: var(--primary-navy); margin: 0;">Edit Brand</h2>
                <p style="color: var(--text-muted); font-size: 14px;">Updating record for: <strong class="text-primary">${brandDto.identifier}</strong></p>
            </div>

            <form:form id="editBrandForm" method="POST" action="update" modelAttribute="brandDto">
                ...
                <div class="form-group">
                    ...
                    <div class="input-control input-readonly">Active</div>
                    <div class="mt-2" style="font-size: 11px; color: var(--text-muted);">
                        To deactivate this brand, please use the Archive/Delete option in the directory.
                    </div>
                </div>
