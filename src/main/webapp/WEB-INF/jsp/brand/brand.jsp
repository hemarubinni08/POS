...
<div class="main-container">
    ...
    <div class="card">
        ...
        <c:if test="${not empty brandDto}">
            <form:form action="/brand/update"
                       method="post"
                       modelAttribute="brandDto">

                <form:hidden path="id" value="${brandDto.id}"/>

                <div class="mb-3">
                    <label for="identifier" class="form-label fw-semibold">Brand Identifier</label>
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    form.addEventListener("submit", function (e) {
        ...
        if (!nameRegex.test(name.value.trim())) {
            return showError(
                name,
                "Brand name should contain only letters"
            );
        }
