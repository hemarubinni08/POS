...
<div class="container">
    ...
    <form action="${pageContext.request.contextPath}/brand/update" method="post">
        <div class="form-group">
            <label>ID</label>
            <input type="text" name="id" value="${brand.id}" readonly />
        </div>
        <div class="form-group">
            <label>Brand Name</label>
            <input type="text" name="identifier" value="${brand.identifier}" readonly />
        </div>
        <div class="form-group">
            <label>Description</label>
            <textarea name="description" required>${brand.description}</textarea>
        </div>
        <div class="btn-group">
