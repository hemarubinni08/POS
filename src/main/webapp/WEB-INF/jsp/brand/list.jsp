...
<head>
    ...
    <title>Retail POS | Brand Management</title>
                        ...
                        <c:choose>
                            <c:when test="${not empty brands}">
                                <c:forEach var="brand" items="${brands}">
                                    <tr>
                                        <td class="ps-4">
                                            <div style="font-weight: 600; color: var(--text-muted);"># ${brand.id}</div>
                                        </td>
                                        ...
                                        <td class="text-end pe-4">
                                            <div class="d-flex justify-content-end gap-2">
                                                <a class="btn btn-outline-primary btn-sm px-3 btn-op"
                                                   href="${pageContext.request.contextPath}/brand/get?identifier=${brand.identifier}">Edit</a>
                                                <a class="btn btn-outline-danger btn-sm px-3 btn-op"
                                                   ...
                                                   onclick="return confirm('Archive this brand?');">Delete</a>
                                            </div>
                                        </td>
                                    </tr>
                                </c:forEach>
