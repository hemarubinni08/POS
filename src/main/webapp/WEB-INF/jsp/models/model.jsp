...
<head>
    ...
    <title>Retail POS | Edit Model</title>
...
<body>
    ...
    <main class="main-content">
        <div class="form-card">
            <div class="mb-4">
                <h2 style="font-weight: 800; color: var(--primary-navy); margin: 0;">Edit Model</h2>
                <p style="color: var(--text-muted); font-size: 14px;">Updating record for: <strong class="text-primary">${modelsDto.identifier}</strong></p>
            </div>

            <form:form id="editModelForm" method="POST" action="update" modelAttribute="modelsDto">

                <%-- Hidden ID for JPA update --%>
                <form:hidden path="id" />

                <div class="form-group">
                    <label>Model Identifier (Fixed)</label>
