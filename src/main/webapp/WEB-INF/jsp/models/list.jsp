...
<div id="content" class="content">
    <div class="card">
        ...
        <c:if test="${empty modelss}">
            <div class="alert">No modelss found</div>
        </c:if>
        ...
        <c:if test="${not empty modelss}">
            <table>
                ...
                <tbody>
                <c:forEach var="models" items="${modelss}">
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-danger"
                               href="/models/delete?identifier=${models.identifier}"
                               onclick="return confirm('Are you sure you want to delete this models?');">
                                Delete
                            </a>
                            <a class="btn btn-primary"
                               href="/models/get?identifier=${models.identifier}">
                                Update
                            </a>
                        </td>
                    </tr>
        ...
        <div class="footer">
            ...
            <a class="btn btn-success" href="/models/add">+ Add New Models</a>
        </div>
