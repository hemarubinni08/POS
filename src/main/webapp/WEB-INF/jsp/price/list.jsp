...
<div id="content" class="content">
    <div class="card">
        ...
        <c:if test="${empty prices}">
            <div class="alert">No prices found</div>
        </c:if>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-danger"
                               href="/price/delete?identifier=${price.identifier}"
                               onclick="return confirm('Are you sure you want to delete this price?');">
                                Delete
                            </a>
                            <a class="btn btn-primary"
                               href="/price/get?identifier=${price.identifier}">
                                Update
                            </a>
                        </td>
                    </tr>
        ...
        <div class="footer">
            ...
            <a class="btn btn-success" href="/price/add">+ Add New Price</a>
        </div>
