...
<div id="content" class="content">
    <div class="card">
        ...
        <c:if test="${empty price}">
            <div class="alert">Price not found</div>
        </c:if>
        ...
        <c:if test="${not empty price}">
            <form:form action="/price/update" method="post" modelAttribute="price">
                ...
                <form:select path="product" required="true" style="pointer-events:none;background:#eee;">
                <form:option value="" label="-- Select product --"/>
                <form:options items="${products}" itemValue="name" itemLabel="name" readOnly="true"/>
                </form:select>
                ...
                <label>Price Type</label>
                        <form:select path="priceType" required="true" style="pointer-events:none;background:#eee;">
                ...
                <div class="btn-group">
                    <a href="/price/list" class="btn btn-secondary">Back</a>
