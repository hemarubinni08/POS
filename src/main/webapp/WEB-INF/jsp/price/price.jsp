...
<head>
    ...
    <title>Retail POS | Update Pricing</title>
...
<body>
    ...
    <main class="main-content">
        <div class="form-card">
            <div class="mb-4">
                <h2 style="font-weight: 800; color: var(--primary-navy); margin: 0;">Edit Price Record</h2>
                <p style="color: var(--text-muted); font-size: 14px;">Adjust financial parameters for the selected product.</p>
            </div>

            <form:form action="${pageContext.request.contextPath}/price/update" method="POST" modelAttribute="priceDto">

                <%-- Crucial: Hidden ID inherited from CommonFields --%>
                <form:hidden path="id" />
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>Product Identifier (Locked)</label>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <form:input path="costPrice" type="number" step="0.01" class="input-control" required="true"/>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Selling Price (₹)</label>
                            <form:input path="sellingPrice" type="number" step="0.01" class="input-control" required="true"/>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>MRP (₹)</label>
                            <form:input path="mrp" type="number" step="0.01" class="input-control" required="true"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <form:input path="effectiveFrom" type="datetime-local" class="input-control" value="${fn:substring(priceDto.effectiveFrom, 0, 16)}" required="true"/>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Effective To</label>
                            <form:input path="effectiveTo" type="datetime-local" class="input-control" value="${fn:substring(priceDto.effectiveTo, 0, 16)}" required="true"/>
                        </div>
                    </div>
                </div>

                <div class="d-flex justify-content-between align-items-center mt-4">
                    <a href="${pageContext.request.contextPath}/price/list" class="btn-cancel">Cancel</a>
