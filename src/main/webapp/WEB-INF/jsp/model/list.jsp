...
<div class="container">
                        ...
                        <tr>
                               ...
                               <td>
                                   <label class="switch">
                                       <input type="checkbox"
                                              ...
                                              onchange="toggleStatus('${model.identifier}', this)">
                            ...
                            <td>
                                ...
                                <a class="action-btn edit-btn"
                                   href="${pageContext.request.contextPath}/model/get?identifier=${model.identifier}">
                                    Edit
                                </a>

                                <a class="action-btn delete-btn"
                                   href="${pageContext.request.contextPath}/model/delete?identifier=${model.identifier}"
    ...
    <div class="btn-container">
        ...
        <a href="${pageContext.request.contextPath}/model/add" class="btn add-btn">
            Add New Model
        </a>
...
function toggleStatus(identifier, el) {
    ...
    fetch('${pageContext.request.contextPath}/model/toggle', {
        method: 'POST',
