...
<div class="container">
    ...
    <div class="header">
        ...
        <div class="header-actions">
            ...
            <a href="${pageContext.request.contextPath}/model/add" class="add-btn">
                + Add New Model
            </a>
        </div>
    </div>
    ...
    <table>
        ...
        <c:forEach items="${models}" var="model">
            <tr>
                ...
                <td>
                    <form method="get"
                          action="${pageContext.request.contextPath}/model/toggleStatus">
                ...
                <td>
                    <form class="action-form"
                          method="get"
                          action="${pageContext.request.contextPath}/model/get">
                        <input type="hidden" name="identifier" value="${model.identifier}" />
                    ...
                    <form class="action-form"
                          method="get"
                          action="${pageContext.request.contextPath}/model/delete"
