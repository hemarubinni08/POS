...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <h4 class="text-center mb-4">List of Models</h4>
                    ...
                    <c:forEach var="model" items="${models}">
                        <tr>
                            ...
                            <td class="d-flex justify-content-center gap-2">
                                <a href="/model/get?identifier=${model.identifier}"
                                   class="btn btn-primary btn-sm">
                                    Edit
                                </a>

                                <a href="/model/delete?identifier=${model.identifier}"
            ...
            <div class="d-flex justify-content-center gap-3 mt-4">
                ...
                <a href="/model/add" class="btn btn-primary">+ Add New Model</a>
            </div>
