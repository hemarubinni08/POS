...
<head>
    <meta charset="UTF-8">
    <title>Retail POS | Add RACK</title>
...
<div class="container">
    ...
    <a href="${pageContext.request.contextPath}/rack/list" class="back-btn">← Back</a>

    <div class="header">
        <h2>Add New Rack</h2>
        <p>Create a rack with shelves and status</p>
    </div>
    ...
    <form:form method="post"
        ...
        <label>Shelves</label>
        <p class="helper-text">(Hold Ctrl/Cmd to select multiple)</p>
