        ...
        <c:if test="${not empty stock}">
            <form:form action="/stock/update" method="post" modelAttribute="stock">
                ...
                <label>Status</label>
                        ...
                        <form:option value="InStock" label="InStock"/>
                        <form:option value="OutOfStock" label="OutOfStock"/>
                        </form:select>

                <label>Warehouse</label>
                        <form:select path="warehouse" required="true" style="pointer-events:none;background:#eee;">
                ...
                <div class="btn-group">
                    <a href="/stock/list" class="btn btn-secondary">Back</a>
