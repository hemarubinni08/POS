...
<head>
    ...
    <title>Retail POS | Stock Inventory</title>
    ...
    <main class="main-content">
        <div class="data-card">
            <div class="card-header-custom">
                <div>
                    <h4 class="m-0" style="font-weight: 800; color: var(--primary-navy);">Stock Management</h4>
                    <p class="m-0 text-muted" style="font-size: 13px;">Overview of product inventory across all warehouses.</p>
                </div>
                <a href="${pageContext.request.contextPath}/stock/add" class="btn btn-primary"
                        ...
                        <c:choose>
                            <c:when test="${fn:length(stocks) > 0}">
                                <c:forEach var="stock" items="${stocks}">
                                    <tr>
                                        <td class="ps-4">
                                            <div style="font-weight: 600; color: var(--text-muted);"># ${stock.id}</div>
                                        </td>
                                        ...
                                        <td>
                                            <div style="font-family: monospace; font-weight: 800; color: var(--primary-navy); font-size: 15px;">
                                                ${stock.quantity} Units
                                            </div>
                                        </td>

                                        <td>
                                            <span class="role-badge">${stock.warehouses}</span>
                                        </td>

                                        <td class="text-end pe-4">
                                            <div class="d-flex justify-content-end gap-2">
                                                <a class="btn btn-outline-primary btn-sm px-3 btn-op"
                                                   href="${pageContext.request.contextPath}/stock/get?identifier=${stock.identifier}">Edit</a>
                                                <a class="btn btn-outline-danger btn-sm px-3 btn-op"
                                                   ...
                                                   onclick="return confirm('Remove this stock record?');">Delete</a>
                                            </div>
                                        </td>
                                    </tr>
                                </c:forEach>
                            ...
                            <c:otherwise>
                                <tr><td colspan="5" class="text-center py-5 text-muted">No stock records found.</td></tr>
                            </c:otherwise>
                        </c:choose>
                    </tbody>
                </table>
