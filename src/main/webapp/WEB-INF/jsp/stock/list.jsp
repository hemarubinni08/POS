...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <!-- Page Title -->
            <h4 class="text-center mb-4">List of Stocks</h4>
                        ...
                        <tr>
                            ...
                            <td>
                                <c:choose>
                                    ...
                                    <c:when test="${stock.quantity lt stock.reorderLevel}">
                            ...
                            <td class="d-flex justify-content-center gap-2">
                                <a href="/stock/get?id=${stock.id}"
                                   class="btn btn-primary btn-sm">
                                    Edit
                                </a>

                                <a href="/stock/delete?id=${stock.id}"
            ...
            <div class="d-flex justify-content-center gap-3 mt-4">
                ...
                <a href="/stock/add" class="btn btn-primary">+ Add New Stock</a>
            </div>
