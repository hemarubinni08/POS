...
<head>
    <meta charset="UTF-8">
    <title>POS Retail Management | Stock Management</title>
...
<div class="container">
    ...
    <div class="content-body">
        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:25px;">
            <h2 style="margin:0; font-size:18px; color:#1F2937;">Stock Management</h2>
            <a href="${pageContext.request.contextPath}/stock/add" class="btn-add">
                + Add New Stock
            </a>
        </div>
        ...
        <table>
            ...
            <c:forEach var="stock" items="${stocks}">
                <tr>
                    <td style="font-weight:600; color:#6B7280;">${stock.id}</td>
                    <td style="font-weight:600;">${stock.identifier}</td>
