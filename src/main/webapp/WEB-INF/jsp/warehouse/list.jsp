...
<div id="content" class="content">
    <div class="card">
        ...
        <c:if test="${empty warehouses}">
            <div class="alert">No warehouses found</div>
        </c:if>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-danger"
                               href="/warehouse/delete?identifier=${warehouse.identifier}"
        ...
        <div class="footer">
            ...
            <a class="btn btn-success" href="/warehouse/add">+ Add New Warehouse</a>
        </div>
