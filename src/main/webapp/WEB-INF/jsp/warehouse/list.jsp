...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <!-- Page Title -->
            <h4 class="text-center mb-4">List of Warehouses</h4>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="form-check form-switch">
                                    <input
                                        class="form-check-input warehouse-toggle"
                                        type="checkbox"
            ...
            <div class="d-flex justify-content-center gap-3 mt-4">
                ...
                <a href="/warehouse/add" class="btn btn-primary">+ Add New Warehouse</a>
            </div>
...
document.addEventListener("change", function (e) {
    if (!e.target.classList.contains("warehouse-toggle")) return;

    const checkbox = e.target;
    const identifier = checkbox.dataset.identifier;
    const status = checkbox.checked;

    fetch("/warehouse/toggle", {
        method: "POST",
        headers: {
