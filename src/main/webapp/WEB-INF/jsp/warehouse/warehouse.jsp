...
<head>
    <meta charset="UTF-8">
    <title>Warehouse Management | Edit Warehouse</title>
        ...
        <div class="col-md-6">
            ...
            <div class="card card-edit">
                <div class="card-header text-center">
                    <h3 class="mb-0"><i class="bi bi-pencil-square me-2"></i> Edit Warehouse</h3>
                </div>
                ...
                <div class="card-body p-4">
                    ...
                    <form action="${pageContext.request.contextPath}/warehouse/update" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text">Identifier cannot be changed after creation.</div>
                        </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <a href="${pageContext.request.contextPath}/warehouse/list" class="btn btn-outline-secondary">
