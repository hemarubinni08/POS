...
<head>
    ...
    <title>Retail POS | Add Shelfs</title>
...
<body>
    ...
    <main class="main-content">
        <div class="form-card">
            <div class="mb-4">
                <h2 style="font-weight: 800; color: var(--primary-navy); margin: 0;">Add Shelfs</h2>
                <p style="color: var(--text-muted); font-size: 14px;">Define storage locations for your inventory.</p>
            </div>

            <form:form id="shelfsForm" method="POST" action="add" modelAttribute="shelfsDto">

                <div class="form-group">
                    <label>Shelf Identifier</label>
                    <form:input path="identifier" class="input-control" placeholder="e.g. SH-A1-SEC2" required="true"/>
                    ...
                    <div class="mt-2" style="font-size: 11px; color: var(--text-muted);">
                        Provide a unique identifier for this storage unit.
                    </div>
                </div>
