...
<div class="container">
    ...
    <table>
        ...
        <c:if test="${empty shelfs}">
            <tr>
                <td colspan="3">No shelfs available</td>
            </tr>
        </c:if>
        ...
        <c:forEach items="${shelfs}" var="shelf">
            <tr>
                ...
                <td>
                    <form method="get"
                          action="${pageContext.request.contextPath}/shelfs/toggleStatus">
                ...
                <td>
                    <form class="action-form"
                          method="get"
                          action="${pageContext.request.contextPath}/shelfs/get">
                        <input type="hidden" name="identifier" value="${shelf.identifier}" />
                    ...
                    <form class="action-form"
                          method="get"
                          action="${pageContext.request.contextPath}/shelfs/delete"
