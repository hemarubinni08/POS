...
<div id="content" class="content">
    <div class="card">
        ...
        <c:if test="${empty shelfs}">
            <div class="alert">Shelfs not found</div>
        </c:if>

        <c:if test="${not empty shelfs}">
            <form:form action="/shelfs/update" method="post" modelAttribute="shelfs">
                ...
                <div class="btn-group">
                    <a href="/shelfs/list" class="btn btn-secondary">Back</a>
