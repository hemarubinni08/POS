        ...
        <section class="main-content">
            <div class="data-card">
                <div class="card-header-custom">
                    <h5 class="m-0 font-weight-bold" style="color: var(--text-dark);">User Management</h5>
                    <a href="/register" class="btn btn-primary btn-action">
                        + Add New Staff
                    </a>
                </div>
                                            ...
                                            <td class="text-end">
                                                <div class="d-flex justify-content-end gap-2">
                                                    ...
                                                    <a class="btn btn-outline-danger btn-action"
                                                       ...
                                                       onclick="return confirm('Delete this staff record? This cannot be undone.');">
                                                        Delete
                                                    </a>
                                                </div>
                                            </td>
