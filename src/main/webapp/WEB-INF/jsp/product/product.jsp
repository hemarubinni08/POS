    ...
    <div class="card">
        ...
        <c:if test="${not empty productDto}">
            <form:form action="/product/update"
                ...
                <form:hidden path="id" value="${productDto.id}"/>

                <div class="mb-4">
                    <label for="identifier" class="form-label">Product Identifier</label>
                ...
                <div class="category-group">
                        ...
                        <form:select path="category" cssClass="form-control" multiple="true" size="4">
