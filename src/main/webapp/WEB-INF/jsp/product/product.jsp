...
<div class="card">
    ...
    <c:if test="${not empty productDto}">
        <form:form action="/product/update" method="post" modelAttribute="productDto">
            ...
            <div class="form-group">
                ...
                <form:input path="unit" placeholder="Enter Unit"/>
            </div>


            <div class="button-group">
                <a href="/product/list" class="btn-cancel">Cancel</a>
