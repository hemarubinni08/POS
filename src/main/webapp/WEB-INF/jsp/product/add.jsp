...
<div class="card">
    ...
    <form:form method="post" action="/product/add" modelAttribute="productDto">
        ...
        <div class="mb-3">
            ...
            <form:input path="identifier" placeholder="Enter Product Id" required="true"/>

            <label class="form-label">Product Name</label>
            <form:input path="name" placeholder="Enter Product name" required="true"/>

            <label class="form-label">Product Unit</label>
            <form:input path="unit" placeholder="Enter Unit" required="true"/>

            <label class="form-label">Product Price</label>
            <form:input path="price" placeholder="Enter Product Price" required="true"/>
