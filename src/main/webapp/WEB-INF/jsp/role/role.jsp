...
<head>
    ...
    <title>Edit Role | Retail Core</title>
...
<body>
    ...
    <main class="content-wrapper">
        <header class="top-navbar">
            ...
            <div class="breadcrumb-text small text-muted">Configuration / Update Role</div>
        </header>

        <section class="main-content">
            <div class="form-card">
                <h4 class="mb-4 font-weight-bold" style="color: var(--text-dark);">Edit System Role</h4>

                <c:if test="${empty role}">
                    <div class="alert alert-danger border-0 small py-2">
                        System Error: Role data not found.
                    </div>
                </c:if>

                <c:if test="${not empty role}">
                    <form:form action="/role/update" method="post" modelAttribute="roleDto">
                        <form:hidden path="identifier" value="${role.identifier}"/>
