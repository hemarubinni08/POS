...
<body>
    ...
    <main class="content-wrapper">
        <header class="top-navbar">
            ...
            <div class="breadcrumb-text small text-muted">Configuration / Access Roles</div>
        </header>

        <section class="main-content">
            <div class="form-card">
                <h4 class="mb-4 font-weight-bold" style="color: var(--text-dark);">Add New Role</h4>

                <c:if test="${not empty role}">
                    <div class="alert alert-success border-0 small py-2">
                        Role "<strong>${role}</strong>" added successfully.
                    </div>
                </c:if>
                ...
                <form:form method="post" action="/role/add" modelAttribute="roleDto">
                    ...
                    <button type="submit" class="btn-submit">Initialize Role</button>
                </form:form>

                <div class="text-center mt-4">
                    <a href="${pageContext.request.contextPath}/role/list" class="text-decoration-none small font-weight-bold" style="color: var(--text-muted);">
