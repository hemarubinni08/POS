...
<div id="content" class="content">
    <div class="card">
        ...
        <c:if test="${empty categorys}">
            <div class="alert">No categorys found</div>
        </c:if>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-danger"
                               href="/category/delete?identifier=${category.identifier}"
                               onclick="return confirm('Are you sure you want to delete this category?');">
                                Delete
                            </a>
                            <a class="btn btn-primary"
                               href="/category/get?identifier=${category.identifier}">
                                Update
                            </a>
                        </td>
                    </tr>
        ...
        <div class="footer">
            ...
            <a class="btn btn-success" href="/category/add">+ Add New Category</a>
        </div>
