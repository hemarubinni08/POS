...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <h4 class="text-center mb-4">List of Categories</h4>
                ...
                <div class="table-wrapper">
                    ...
                    <c:forEach var="category" items="${categories}">
                        <tr>
                            ...
                            <td>
                                <span class="${empty category.superCategory ? 'fw-bold text-primary' : ''}">
                                    ${empty category.superCategory ? 'Root' : category.superCategory}
                                </span>
                            </td>
