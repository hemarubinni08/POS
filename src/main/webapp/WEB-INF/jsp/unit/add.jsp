...
<head>
    ...
    <title>Retail POS | Add Unit of Measure</title>
...
<body>
    ...
    <main class="main-content">
        <div class="form-card">
            <div class="mb-4">
                <h2 style="font-weight: 800; color: var(--primary-navy); margin: 0;">Add Unit</h2>
                <p style="color: var(--text-muted); font-size: 14px;">Define measurement units for stock items.</p>
            </div>

            <form:form id="unitForm" method="POST" action="add" modelAttribute="unitDto">

                <div class="form-group">
                    <label>Unit Identifier</label>
                    <form:input path="identifier" class="input-control" placeholder="e.g. PCS, KG, LTR, BOX" required="true"/>
                    ...
                    <div class="mt-2" style="font-size: 11px; color: var(--text-muted);">
                        Use a standard abbreviation for the unit of measure.
                    </div>
                </div>
