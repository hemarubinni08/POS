    ...
    <main class="main-content">
        <div class="data-card">
            <div class="card-header-custom">
                <h4 class="m-0 font-weight-bold">Module Registry</h4>
                <a href="${pageContext.request.contextPath}/node/add" class="btn btn-primary btn-action">
                    + Register New Node
                </a>
            </div>
                ...
                <table class="table table-hover m-0">
                    <thead>
                        <tr class="table-light">
                            <th class="ps-4" style="width: 20%;">Node ID</th>
