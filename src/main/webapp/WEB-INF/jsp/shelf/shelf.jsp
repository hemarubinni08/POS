...
<div class="card-container">
    ...
    <a href="${pageContext.request.contextPath}/shelf/list" class="back-icon">←</a>
    ...
    <form action="${pageContext.request.contextPath}/shelf/update" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" value="${shelf.identifier}" class="form-control" readonly />
        </div>
        ...
        <button type="submit" class="btn-submit">Update Shelf</button>
    </form>
