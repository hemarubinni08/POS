   ...
   <td>
       <label class="switch">
           <input type="checkbox"
                  ...
                  onchange="toggleStatus('${shelf.identifier}', this)">
    ...
    <td>
        ...
        <a class="action-btn edit-btn"
           href="${pageContext.request.contextPath}/shelf/get?identifier=${shelf.identifier}">
            Edit
        </a>
...
<div class="btn-container">
    ...
    <a href="${pageContext.request.contextPath}/shelf/add" class="btn add-btn">
        Add New Shelf
    </a>
