            ...
            <table>
                ...
                <c:forEach var="shelf" items="${shelves}">
                    <tr>
                        ...
                        <td>
                            <div class="toggle-switch ${shelf.active ? 'active' : ''}"
                                 onclick="toggleShelfStatus('${shelf.id}', this)">
                            </div>
                        </td>
                        ...
                        <td>
                            <div class="actions">
                                <a class="btn-action btn-edit"
                                   href="${pageContext.request.contextPath}/shelf/get?id=${shelf.id}">
                                    Edit
                                </a>
                                <a class="btn-action btn-delete"
                                   href="${pageContext.request.contextPath}/shelf/delete?id=${shelf.id}"
...
<script>
    function toggleShelfStatus(id, el) {
        el.classList.toggle("active");

        fetch('${pageContext.request.contextPath}/shelf/toggle-status?id=' + id, {
            method: 'POST'
