...
<div class="form-grid">
    ...
    <div>
        ...
        <form:input path="name"
                    ...
                    required="true"
                    pattern="[A-Za-z ]{3,}"
                    title="Name should contain only letters and minimum 3 characters"/>
    </div>
    ...
    <div class="full-width">
        ...
        <form:input path="shippingAddress.addressLine"
                    ...
                    <form:hidden path="shippingAddress.addressType" value="shippingAddress"/>
    </div>
    ...
    <div class="full-width">
        ...
        <form:input path="billingAddress.addressLine"
                    ...
                    <form:hidden path="billingAddress.addressType" value="billingAddress"/>
    </div>
