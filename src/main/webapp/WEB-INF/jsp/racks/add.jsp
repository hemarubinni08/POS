...
<div id="content" class="content">
    <div class="card">
        ...
        <form:form method="post" action="/racks/add" modelAttribute="racksDto">
            ...
            <label>Select shelves</label>
                    ...
                    <form:option value="" label="-- Select shelves --"/>
            ...
            <div class="btn-group">
                <a href="/racks/list" class="btn btn-secondary">Back</a>
                <button type="submit" class="btn btn-primary">Add Racks</button>
            </div>
