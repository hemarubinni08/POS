...
<div class="container">
    ...
    <form:form method="post"
        ...
        <div class="form-group">
            ...
            <form:input path="identifier" id="identifier" required="true"/>
        </div>

          <div class="form-group">
                   <label>Shelfs</label>
                   <form:select path="shelfs" multiple="true" required="true">
        ...
        <div class="form-group">
            ...
            <form:select path="status" required="true">
                <form:option value="" disabled="true">-- Select Status --</form:option>
    ...
    <a class="back-link"
       href="${pageContext.request.contextPath}/racks/list">
        ← Back to Rack List
    </a>
