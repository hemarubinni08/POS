...
public class TokenGenerationControllerTest {
    ...
    public TokenGenerationControllerTest(UserDetailsService userDetailsService, AuthenticationProvider authenticationProvider, JWTUtility jwtUtility, UserService userService) {
