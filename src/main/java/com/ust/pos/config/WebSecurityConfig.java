        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/login", "/register", "/api/authenticate",
                                "/api/validateToken", "/swagger-ui/**", "/v3/**").permitAll()
                        .anyRequest().authenticated()
                )
                .logout(org.springframework.security.config.annotation.web.
                        configurers.LogoutConfigurer::permitAll);
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                ...
                .components(new Components().addSecuritySchemes(JAVA_IN_USE_SECURITY_SCHEME,
                        new SecurityScheme()
                                .name(JAVA_IN_USE_SECURITY_SCHEME).type(SecurityScheme.Type.HTTP).
