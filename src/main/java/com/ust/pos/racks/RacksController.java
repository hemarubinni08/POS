...
public class RacksController {
    ...
    @PostMapping("/add")
    public String addPost(Model model, Pageable pageable, @ModelAttribute RacksDto userDto) {
    ...
    @PostMapping("/update")
    public String updatePost(Model model, Pageable pageable, @ModelAttribute RacksDto userDto) {
