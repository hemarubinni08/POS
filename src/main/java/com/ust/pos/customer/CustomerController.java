...
public class CustomerController {
    ...
    public String update(Model model, @RequestParam String identifier) {
        ...
        model.addAttribute("billing", addressService.findByIdentifierAndBilling(identifier));
        model.addAttribute("shipping", addressService.findByIdentifierAndShipping(identifier));
