...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderServiceImpl(CartRepository cartRepository, CartEntryService cartEntryService, OrderRepository orderRepository, OrderItemRepository orderItemRepository, ModelMapper modelMapper) {
    ...
    public OrderDto createOrder(String cartId, String paymentMethod) {
        ...
        order.setSubtotal(cart.getTotalPrice().add(cart.getDiscount() != null ? cart.getDiscount() : BigDecimal.ZERO));
    ...
    public Page<OrderDto> findAll(Pageable pageable, String search) {
        ...
        if (search != null && !search.trim().isEmpty()) {
            ...
            page = orderRepository.findAll(PageRequest.of(pageable.getPageNumber(), pageable.getPageSize(), Sort.by(Sort.Direction.DESC, "createdAt"))
            );        }
        Type listType = new TypeToken<List<OrderDto>>() {}.getType();
