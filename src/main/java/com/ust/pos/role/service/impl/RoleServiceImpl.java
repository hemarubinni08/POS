...
public class RoleServiceImpl implements RoleService {
    ...
    public WsDto<RoleDto> findAll(Pageable pageable) {
        ...
        Page<Role> productPage = roleRepository.findAll(pageable);
        WsDto<RoleDto> roleWsDto = new WsDto<>();
        roleWsDto.setDtoList(modelMapper.map(productPage.getContent(), listType));
        roleWsDto.setTotalRecords(productPage.getTotalElements());
        roleWsDto.setTotalPage(productPage.getTotalPages());
